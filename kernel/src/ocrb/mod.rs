...
/// Run all Phase 9 OCRB tests and print results
pub fn run_phase9_gate() {
    serial_println!("[OCRB] ============================================");
    serial_println!("[OCRB]   Phase 9 — Network Stack Gate");
    serial_println!("[OCRB] ============================================");
...
/// Run all Phase 16 OCRB tests and print results
pub fn run_phase16_gate() {
    serial_println!("[OCRB] ============================================");
    serial_println!("[OCRB]   Phase 16 — Window Manager Foundation Gate");
    serial_println!("[OCRB] ============================================");
