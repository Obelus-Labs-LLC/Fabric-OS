//! OCRB Phase 9 Gate — Network Stack verification tests.
//!
...
fn test_socket_table_crud() -> OcrbResult {
...
fn test_ipv4_addr_socketaddr() -> OcrbResult {
...
fn test_ring_buffer() -> OcrbResult {
...
fn test_loopback_delivery() -> OcrbResult {
...
fn test_udp_send_recv() -> OcrbResult {
...
fn test_tcp_handshake() -> OcrbResult {
    use crate::network::addr::{Ipv4Addr, SocketAddr, SocketType, Protocol};
...
fn test_tcp_data_transfer() -> OcrbResult {
    use crate::network::addr::{Ipv4Addr, SocketAddr, SocketType, Protocol};
    use crate::network::ops;
    use fabric_types::ProcessId;
...
fn test_syscall_socket_send_recv() -> OcrbResult {
    use crate::network::addr::{Ipv4Addr, SocketAddr, SocketType, Protocol};
    use crate::network::ops;
    use fabric_types::ProcessId;
...
fn test_socket_cleanup() -> OcrbResult {
    use crate::network::addr::{SocketType, Protocol};
    use crate::network::ops;
    use fabric_types::ProcessId;
...
fn test_error_paths() -> OcrbResult {
    use crate::network::addr::{Ipv4Addr, SocketAddr, SocketType, Protocol};
