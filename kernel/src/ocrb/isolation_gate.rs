//! OCRB Phase 6 — Isolation Gate Tests (10 tests).
//!
...
fn test_1_address_space_create_destroy() -> OcrbResult {
...
fn test_2_kernel_mapping_integrity() -> OcrbResult {
    use crate::address_space::per_process::AddressSpace;
...
fn test_3_handle_storm() -> OcrbResult {
...
fn test_4_handle_stale_detection() -> OcrbResult {
...
fn test_5_revocation_efficiency() -> OcrbResult {
    reset_state();
...
fn test_6_butler_state_persist() -> OcrbResult {
...
fn test_7_break_glass_activation() -> OcrbResult {
...
fn test_8_break_glass_auto_expire() -> OcrbResult {
...
fn test_9_multi_process_handle_isolation() -> OcrbResult {
...
fn test_10_must_use_verify() -> OcrbResult {
