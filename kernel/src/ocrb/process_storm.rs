...
fn test1_butler_root_supervision() -> OcrbResult {
    init_fresh();
...
fn test2_process_lifecycle() -> OcrbResult {
    init_fresh();
    let mut correct = 0u32;
    let total = 5u32;
...
fn test3_intent_aware_scheduling() -> OcrbResult {
    init_fresh();
    let mut correct = 0u32;
    let total = 4u32;
...
fn test4_priority_inheritance() -> OcrbResult {
    init_fresh();
    let mut correct = 0u32;
    let total = 3u32;
...
fn test5_one_for_one_restart() -> OcrbResult {
    init_fresh();
    let mut correct = 0u32;
    let total = 3u32;
...
fn test6_one_for_all_restart() -> OcrbResult {
    init_fresh();
    let mut correct = 0u32;
    let total = 3u32;
...
fn test7_rest_for_one_restart() -> OcrbResult {
    init_fresh();
    let mut correct = 0u32;
    let total = 3u32;
...
fn test8_restart_intensity_escalation() -> OcrbResult {
    init_fresh();
    let mut correct = 0u32;
    let total = 3u32;
...
fn test9_process_crash_storm() -> OcrbResult {
    init_fresh();
    let mut errors = 0u32;
