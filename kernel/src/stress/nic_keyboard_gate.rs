//! STRESS Phase 11 — NIC + Keyboard Gate (11 tests, weight 100).
//!
...
fn test_port_io_exists() -> StressResult {
...
fn test_pci_config_read() -> StressResult {
...
fn test_pci_bus_scan() -> StressResult {
...
fn test_ioapic_init() -> StressResult {
...
fn test_keyboard_buffer() -> StressResult {
...
fn test_virtio_device_found() -> StressResult {
    let devices = crate::pci::scan_bus(0);
...
fn test_virtqueue_setup() -> StressResult {
...
fn test_ethernet_frame_build() -> StressResult {
...
fn test_arp_packet_build() -> StressResult {
...
fn test_dns_query_build() -> StressResult {
...
fn test_http_get_build() -> StressResult {
