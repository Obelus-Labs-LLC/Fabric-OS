//! STRESS Phase 12 — NIC Integration Gate (10 tests, weight 100).
//!
...
fn test_packet_routing_logic() -> StressResult {
...
fn test_nic_tx_smoke() -> StressResult {
...
fn test_arp_gateway_resolved() -> StressResult {
...
fn test_ethernet_rx_demux() -> StressResult {
...
fn test_ip_source_address() -> StressResult {
...
fn test_dns_query_sent() -> StressResult {
...
fn test_dns_hostname_resolved() -> StressResult {
...
fn test_tcp_syn_via_nic() -> StressResult {
...
fn test_udp_over_nic() -> StressResult {
    use crate::network::addr::{Ipv4Addr, SocketAddr, SocketType, Protocol};
    use crate::network::ops;
...
fn test_loopback_still_works() -> StressResult {
    use crate::network::addr::{Ipv4Addr, SocketAddr, SocketType, Protocol};
    use crate::network::ops;
