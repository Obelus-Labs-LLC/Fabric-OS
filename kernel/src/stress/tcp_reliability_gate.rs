//! STRESS Phase 13 — TCP Reliability & Async I/O Gate (10 tests, weight 100).
//!
...
fn test_retransmit_enqueue_ack() -> StressResult {
...
fn test_rto_calculation() -> StressResult {
...
fn test_karns_algorithm() -> StressResult {
    use crate::network::tcp_timer::RetransmitQueue;
...
fn test_retransmit_timeout() -> StressResult {
    use crate::network::tcp_timer::RetransmitQueue;
...
fn test_pollfd_immediate_ready() -> StressResult {
...
fn test_pollfd_timeout_zero() -> StressResult {
    use crate::network::ops::{self, PollFd, POLLIN};
    use crate::network::addr::{SocketType, Protocol};
    use crate::network::SOCKETS;
...
fn test_pollfd_events() -> StressResult {
...
fn test_dns_cache_insert_lookup() -> StressResult {
...
fn test_dns_cache_lru_eviction() -> StressResult {
    use crate::network::dns::DnsCache;
...
fn test_dns_retry_txn_id() -> StressResult {
