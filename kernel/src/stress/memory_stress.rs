...
fn test1_frame_alloc_dealloc() -> StressResult {
    let mut errors = 0u32;
...
fn test2_frame_stress() -> StressResult {
...
fn test3_no_double_alloc() -> StressResult {
...
fn test4_buddy_merge() -> StressResult {
...
fn test5_page_map_unmap() -> StressResult {
...
fn test6_heap_stress() -> StressResult {
...
fn test7_heap_fragmentation() -> StressResult {
