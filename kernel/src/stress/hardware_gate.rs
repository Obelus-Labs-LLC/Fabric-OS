//! Phase 7 STRESS Gate — Hardware Interrupts + Userspace Execution.
//!
...
fn test_gdt_structure() -> StressResult {
...
fn test_idt_populated() -> StressResult {
...
fn test_apic_enabled() -> StressResult {
...
fn test_timer_ticks() -> StressResult {
...
fn test_syscall_msrs() -> StressResult {
...
fn test_ring3_round_trip() -> StressResult {
...
fn test_preemptive_switch() -> StressResult {
    use fabric_types::{ProcessId, ProcessState};
...
fn test_elf_header_parse() -> StressResult {
...
fn test_elf_load_run() -> StressResult {
    let data = crate::elf::TEST_ELF_EXIT42;
